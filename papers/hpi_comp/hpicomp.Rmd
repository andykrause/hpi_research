...
Additionally, we compare the ability of the test set of index methods to perform at smaller geographies; a common desire for many house price index (HPI) use cases. Finally, to the set of existing index methods we add a novel approach -- an index developed with a neural network. 

This paper proceeds by: 
...
