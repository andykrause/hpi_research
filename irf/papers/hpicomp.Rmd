...
subtitle:   
author:
  - Andy Krause* (Zillow Group) andykr@zillowgroup.com
  - Reid Johnson (Zillow Group) reidj@zillowgroup.com
date: "`r Sys.Date()`"
output: 
  html_document:
editor_options: 
...
| sale_date  | Date   | 2012-02-22   | Date of sale   |
